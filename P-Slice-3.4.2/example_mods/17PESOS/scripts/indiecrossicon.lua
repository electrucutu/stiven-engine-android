...
function onUpdatePost(elapsed)
	...
	setProperty('simge1.x', lerp(getProperty('simge1.x'),getProperty('iconP1.x'),0.15))
	setProperty('simge1.y', getProperty('iconP1.y'))
	setProperty('simge2.x', lerp(getProperty('simge2.x'),getProperty('iconP2.x'),0.15))
	...
	if smoothBar == true then
	setProperty('fakeBarBF._frame.frame.width', lerp(getProperty('fakeBarBF._frame.frame.width'),(getProperty('health')/2)*593,0.15))
