...
noteTweenAngle('balls43', 4, 88.914391 * (thecool[downscroll] / 0.7), 0.5, 'sineInOut')
...
noteTweenAngle('balls63', 6, -88.588142 * (thecool[downscroll] / 0.7), 0.5, 'sineInOut')
...
noteTweenAngle('balls73', 7, 92.329109 * (thecool[downscroll] / 0.7), 0.5, 'sineInOut')
