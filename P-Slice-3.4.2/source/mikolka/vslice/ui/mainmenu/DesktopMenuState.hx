...
class DesktopMenuState extends FlxBasic
{
	...
	var uiFront:FlxSprite; // Variable para el marco horizontal
    ...
    public function new(host:MainMenuState) {
		...
		// --- AGREGADO: Cargar UI_Front al frente de los botones del menú ---
		uiFront = new FlxSprite(0, 0);
		uiFront.loadGraphic(Paths.image('UI_Front'));
		uiFront.antialiasing = VsliceOptions.ANTIALIASING;
		uiFront.scrollFactor.set(0, 0); // Fijo a la pantalla
