	...
	function onAcceptPress()
	{
		switch (curOption.type)
		{
			...
			case KEYBIND:
				...
				bindingText = new Alphabet(FlxG.width / 2, 160, 'Reconfigurando ' + curOption.name, false);
				...
				bindingText2 = new Alphabet(FlxG.width / 2, 340,
					'Mantén ' + escape + ' para Cancelar\nMantén ' + backspace + ' para Eliminar', true);
